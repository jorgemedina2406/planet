...
<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="dropdown dropdown-inline">
                    <a href="{{ route('report-import-excel') }}"  class="btn btn-outline-brand btn-elevate btn-icon">
                        <i class="la la-file-excel-o"></i>
                    </a>
                    {{-- <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                        style="position: absolute; transform: translate3d(-150px, 32px, 0px); top: 0px; left: 0px; will-change: transform;">
                        <a class="dropdown-item" href="{{ route('report-import-excel') }}"><i
                                class="la la-file-excel-o"></i> Exportar Excel</a>
                        <a class="dropdown-item" href="{{ route('report-import-pdf') }}"><i
                                class="la la-file-pdf-o"></i> Exportar Pdf</a>
                    </div> --}}
                </div>
                &nbsp;
                <div class="dropdown dropdown-inline">
                    <a href="{{ route('create.import.view') }}" class="btn btn-brand btn-icon-sm">
        ...
        <div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
            <div class="row">
                ...
                <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
                    <div class="kt-form__group">
                        <div class="kt-form__control">
                            <select class="form-control kt-selectpicker" id="kt_form_importer" data-live-search="true">
    ...
    <div class="kt-portlet__body kt-portlet__body--fit">
        ...
        <!--begin: Datatable -->
        <div class="kt-datatable" id="ajax_data" data-route="{{ route('get.data.import') }}"></div>
        <!--end: Datatable -->
                                    ...
                                    <div class="kt-form__group kt-form__group--inline w-100">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group-prepend mt-3 float-right">
                                                <button class="btn btn-brand" id="changeStatus" data-route="{{ route('update.status.import') }}" type="button">Actualizar!</button>
                                            </div>                                                  
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ asset('assets/js/pages/crud/metronic-datatable/base/data-ajax-import.js') }}" type="text/javascript"></script>
