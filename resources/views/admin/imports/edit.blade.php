...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        @include('admin.imports.modal-observation')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('update.import', $import->id) }}"  novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="importId" name="id" value="{{ $import->id }}">
                            <div class="kt-portlet__body pb-0">
                                <div class="kt-section mb-0">
                                    <div class="kt-section__content">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" name="reference" class="form-control" placeholder="" value="{{ $import->reference }}">
                                            </div>
                                            <div class="col-lg-3">
                                                ...
                                                <select class="form-control kt-selectpicker" name="courier_id" data-live-search="true">
                                                    ...
                                                    <option value="{{ $courier->id }}" {{ ($courier->id == $import->courier_id) ? 'selected' : '' }}>{{ $courier->name }}</option>
                                                    @endforeach
                                                </select>                                            
                                            </div>
                                            <div class="col-lg-3">
                                                <label class="form-control-label">* Fecha de notificacion:</label>
                                                <input type="text" name="date_notification" class="form-control kt_datepicker_1" placeholder="" value="{{ $import->date_notification }}">
                                            </div>
                                            <div class="col-lg-3">
                                                <label class="form-control-label">* MAWB:</label>
                                                <input type="text" name="mawb" class="form-control" placeholder="" value="{{ $import->mawb }}">
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* HAWB:</label>
                                                <input type="text" name="hawb" class="form-control" placeholder="" value="{{ $import->hawb }}">
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Linea Aerea / Naviera:</label>
                                                <select class="form-control kt-selectpicker" name="line_id" data-live-search="true">
                                                    <option value="">Seleccionar</option>
                                                    @foreach( $lines as $line )
                                                    <option value="{{ $line->id }}" {{ ($line->id == $import->line_id) ? 'selected' : '' }}>{{ $line->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                ...
                                                <select class="form-control kt-selectpicker" name="cr_id" data-live-search="true">
                                                    <option value="">Seleccionar</option>
                                                    @foreach( $crs as $cr )
                                                    <option value="{{ $cr->id }}" {{ ($cr->id == $import->cr_id) ? 'selected' : '' }}>{{ $cr->code }} - {{ $cr->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                ...
                                                <select class="form-control kt-selectpicker" name="incoterm_id" data-live-search="true">
                                                    ...
                                                    <option value="{{ $incoterm->id }}" {{ ($incoterm->id == $import->incoterm_id) ? 'selected' : '' }}>{{ $incoterm->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Importador:</label>
                                                <select class="form-control kt-selectpicker" name="importer_id" data-live-search="true">
                                                    <option value="">Seleccionar</option>
                                                    @foreach( $importers as $importer )
                                                    <option value="{{ $importer->id }}" {{ ($importer->id == $import->importer_id) ? 'selected' : '' }}>{{ $importer->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Proveedor:</label>
                                                <select class="form-control kt-selectpicker" name="provider_id" data-live-search="true">
                                                    <option value="">Seleccionar</option>
                                                    @foreach( $providers as $provider )
                                                    <option value="{{ $provider->id }}" {{ ($provider->id == $import->provider_id) ? 'selected' : '' }}>{{ $provider->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                ...
                                                <select class="form-control kt-selectpicker" name="consignee_id" data-live-search="true">
                                                    ...
                                                    <option value="{{ $consignee->id }}" {{ ($consignee->id == $import->consignee_id) ? 'selected' : '' }}>{{ $consignee->name }}</option>
                                                    @endforeach
                                                </select>                                            
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Pais de origen:</label>
                                                <div id="country">
                                                    <select class="form-control kt-selectpicker" id="country_old" name="destination_country" data-live-search="true">
                                                        <option value="">Seleccionar</option>
                                                        @foreach( $countries as $country )
                                                        <option value="{{ $country->id }}" {{ ($country->id == $import->destination_country) ? 'selected' : '' }}>{{ $country->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>     
                                            ...
                                            {{-- <div class="col-lg-3 mt-3">
                                                ...
                                                <select class="form-control kt-selectpicker" id="airport" name="airport" data-live-search="true">
                                                    ...
                                                    <option value="{{ $airport->code }}" {{ ($airport->code == $import->airport) ? 'selected' : '' }} data-id="{{ $airport->country_id }}">{{ $airport->code }} - {{ $airport->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div> --}}
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Nro de facturas:</label>
                                                <input type="text" name="nro_invoices" class="form-control" placeholder="" value="{{ $import->nro_invoices }}">
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Fecha de factura:</label>
                                                <input type="text" name="date_invoices" class="form-control kt_datepicker_1" placeholder="" value="{{ $import->date_invoices }}">
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="my-5">
                                    <div class="kt-section__content">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 border-right pr-5">
                                                ...
                                                <div class="form-group row mt-5">
                                                    <!-- FIELDS PATENTS -->
                                                    @include('admin.imports.fields.fields_patents')
                                                    <!-- END FIELDS PATENTS -->
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row mt-2">
                                                    <!-- FIELDS OTHERS -->
                                                    @include('admin.imports.fields.fields_others')
                                                    <!-- END FIELDS OTHERS -->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 border-right pr-5">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <button type="button" class="btn btn-danger btn-icon btn-icon-sm delete-protocol" data-route="{{ route('delete.protocol.import', $item->id) }}"><i class="flaticon2-trash" title="Eliminar Protocolo"></i></button>
                                                                </div>
                                                            </div>                                                       
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <button type="button" class="btn btn-brand" onclick="addProtocol({{count($protocolsImports)}});">Agregar otro</button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 pl-5">
                                                    ...
                                                    @foreach( $cardsImports as $key => $item )
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <button type="button" class="btn btn-danger btn-icon btn-icon-sm delete-card" data-route="{{ route('delete.card.import', $item->id) }}"><i class="flaticon2-trash" title="Eliminar Carta"></i></button>
                                                                </div>
                                                            </div>                                                       
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label class="form-control-label">&nbsp;</label>
                                                        <button type="button" class="btn btn-brand" onclick="addCard({{count($cardsImports)}});">Agregar otro</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            @foreach( $productsImports as $key => $item )
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            @foreach( $permissionsImports as $key => $item )
                                            <div class="col-lg-3 mt-4">
                                                   
                                                <select class="form-control kt-selectpicker permission_add" id="permission_add" name="permission[]" data-live-search="true">
                                                    <option value="">Seleccionar</option>
                                                    @foreach( $permissions as $permission )
                                                    <option value="{{ $permission->id }}" {{ ($permission->id == $item->permit_id) ? 'selected' : '' }}>{{ $permission->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mt-4">
                                            ...
                                            <div class="col-lg-2 mt-4">
                                                <div>
                                                    <button type="button" class="btn btn-sm btn-clean btn-icon btn-icon-sm ml-2 delete_permission" data-route="{{ route('delete.permission.import',$item->id) }}"><i class="la la-trash"></i></button>
                                                </div>
                                            </div>
                                            @endforeach
                                            <div class="col-lg-3">
                                        ...
                                        <div class="form-group row mt-5 text-left">
                                            @if( isset($import->evidence) && $import->evidence != '' )
                                                @foreach( explode(',', $import->evidence) as $key => $item )
                                                <div class="col">
                                                    ...
                                                    <button type="button" data-route="{{ route('delete.evidence.import', [$import->id, $key]) }}" class="btn btn-danger btn-icon btn-icon-sm delete-evidence"><i class="flaticon2-trash" title="Eliminar Evidencia"></i></button>
                                                </div>
                                            
                                                @include('admin.imports.modal-evidence')
                                            
                                                @endforeach
                                            @endif
    
                                            @php
                                                $count = count(explode(',', $import->evidence));
                                            @endphp
...
<script src="{{ asset('assets/js/pages/crud/forms/validation/imports-validation.js') }}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var count = '{{ count($protocolsImports) }}';
    ...
    var count_card = '{{ count($cardsImports) }}';
    ...
    function addPediment(){
        ...
        field_pediment = '<select class="form-control mt-3 kt-selectpicker" name="pediment_id[]" data-live-search="true">' + options + '</select>';
