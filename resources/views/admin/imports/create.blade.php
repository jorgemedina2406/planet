            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('create.import') }}"  novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="kt-section__content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" name="date_notification" class="form-control kt_datepicker_1" id="" readonly="" placeholder="" autocomplete="false">
                                            </div>
                                            <div class="col-lg-3">
                                            ...
                                            {{-- <div class="col-lg-3 mt-3">
                                                ...
                                                <select class="form-control kt-selectpicker" id="airport" name="airport" data-live-search="true">
                                                    ...
                                                    <option value="{{ $airport->code }}" data-id="{{ $airport->country_id }}">{{ $airport->code }} - {{ $airport->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div> --}}
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Nro de facturas:</label>
                                                <input type="text" name="nro_invoices" class="form-control" placeholder="" value="">
                                            </div>
                                            <div class="col-lg-3 mt-3">
                                                <label class="form-control-label">* Fecha de factura:</label>
                                                <input type="text" name="date_invoices" class="form-control kt_datepicker_1" id="" readonly="" placeholder="" autocomplete="false">
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="my-5">
                                    <div class="kt-section__content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 pl-5">
                                                ...
                                                <div class="form-group row mt-5">
                                                    <!-- FIELDS PEDIMENTS -->
                                                    @include('admin.imports.fields.fields_pediments')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-group row mt-2">
                                                    <!-- FIELDS OTHERS -->
                                                    @include('admin.imports.fields.fields_others_create')
                                                    <!-- END FIELDS OTHERS -->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 border-right pr-5">
                                                ...
                                                <div class="form-group row mt-5" id="protocol">
                                                    <!-- FIELDS PROTOCOLS -->
                                                    @include('admin.imports.fields.fields_protocols')
                                            ...
                                            <div class="col-md-6 pl-5">
                                                ...
                                                <div class="form-group row mt-5" id="card">
                                                    <!-- FIELDS CARDS -->
                                                    @include('admin.imports.fields.fields_cards')
                                                    <!-- END FIELDS CARDS -->
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group row mt-5">
                                            <!-- FIELDS PRODUCTS -->
                                            @include('admin.imports.fields.fields_products')
                                            <!-- END FIELDS PRODUCTS -->
                                        </div>
                                        <hr class="my-5">
                                        ...
                                        <div class="form-group row mt-5">
                                            <!-- FIELDS PERMISSIONS -->
                                            @include('admin.imports.fields.fields_permissions')
