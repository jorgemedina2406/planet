...
@section('content')
    ...
    <!-- begin::Modal Create -->
    @include('admin.catalogs.products.create')
    <!-- end::Modal Create -->
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    &nbsp;
                    <div class="dropdown dropdown-inline">
                        <button type="button" class="btn btn-brand btn-icon-sm" data-toggle="modal" data-target="#newProduct">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="ajax_data" data-route="{{ route('get.data.product') }}"></div>
            <!--end: Datatable -->
...
<script src="{{ asset('assets/js/pages/crud/metronic-datatable/base/data-ajax-product.js') }}" type="text/javascript"></script>
