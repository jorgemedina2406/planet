            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('update.consignee', $consignee->id) }}"  novalidate="novalidate">
                            @csrf
                                    ...
                                    <div class="kt-section__content">
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="" value="{{ $consignee->name }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-control-label">Calle:</label>
                                                <input type="text" name="street" class="form-control" placeholder="" value="{{ $consignee->street }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-control-label">Nro. Ext:</label>
                                                <input type="text" name="nro_ext" class="form-control" placeholder="" value="{{ $consignee->nro_ext }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-control-label">Nro. Int:</label>
                                                <input type="text" name="nro_int" class="form-control" placeholder="" value="{{ $consignee->nro_int }}">
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <label class="form-control-label">Colonia:</label>
                                                <input type="text" name="colony" class="form-control" placeholder="" value="{{ $consignee->colony }}">
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <label class="form-control-label">Municipio:</label>
                                                <input type="text" name="municipality" class="form-control" placeholder="" value="{{ $consignee->municipality }}">
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <label class="form-control-label">Entidad Federal:</label>
                                                <input type="text" name="federal_entity" class="form-control" placeholder="" value="{{ $consignee->federal_entity }}">
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <label class="form-control-label">Cod. Postal:</label>
                                                <input type="text" name="postal" class="form-control" placeholder="" value="{{ $consignee->postal }}">
                                            </div>
                                            <div class="col-md-3 mt-4">
