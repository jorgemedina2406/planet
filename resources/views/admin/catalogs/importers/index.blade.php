...
@section('content')
    ...
    <!-- begin::Modal Create -->
    @include('admin.catalogs.importers.create')
    <!-- end::Modal Create -->
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    &nbsp;
                    <div class="dropdown dropdown-inline">
                        <button type="button" class="btn btn-brand btn-icon-sm" data-toggle="modal" data-target="#newImporter">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 order-2 order-xl-1">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-input-icon kt-input-icon--left">
                                    <input type="text" class="form-control" placeholder="Importador..." id="exportersearch">
                                    <span class="kt-input-icon__icon kt-input-icon__icon--left">
                                        <span><i class="la la-search"></i></span>
                                    </span>
                                </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="ajax_data" data-route="{{ route('get.data.importer') }}"></div>
            <!--end: Datatable -->
...
<script src="{{ asset('assets/js/pages/crud/metronic-datatable/base/data-ajax-importer.js') }}" type="text/javascript"></script>
