            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('update.patent', $patent->id) }}"  novalidate="novalidate">
                            @csrf
                                    ...
                                    <div class="kt-section__content">
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="patent" class="form-control" placeholder="" value="{{ $patent->patent }}">
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="form-control-label">* Agente Aduanal:</label>
                                                <input type="text" name="agent_aduanal" class="form-control" placeholder="" value="{{ $patent->agent_aduanal }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
