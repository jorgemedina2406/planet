<div class="modal fade" id="newCountry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-modal="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('create.country') }}" id="kt_form_1" method="post">
