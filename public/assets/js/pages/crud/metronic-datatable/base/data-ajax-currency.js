...
var KTDatatableRemoteAjaxDemo = function() {
    ...
    var demo = function() {
        ...
        var route_edit = app_url + '/administracion/catalogos/editar-moneda';
        var route_view = app_url + '/administracion/catalogos/moneda';
        var route_delete = app_url + '/administracion/catalogos/delete-currency';
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    var estatus = {
                        0: { 'title': 'Desactivada', 'class': ' kt-badge--danger' },
                        1: { 'title': 'Activa', 'class': 'kt-badge--success' }
                    };
