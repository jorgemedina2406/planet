...
var KTDatatableRemoteAjaxDemo = function() {
    ...
    var demo = function() {
        ...
        var route_edit = app_url + '/administracion/catalogos/editar-pedimento';
        var route_view = app_url + '/administracion/catalogos/pedimento';
        var route_delete = app_url + '/administracion/catalogos/delete-pediment';
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    var estatus = {
                        'desactivado': { 'title': 'Desactivado', 'class': ' kt-badge--danger' },
                        'activado': { 'title': 'Activo', 'class': 'kt-badge--success' }
                    };
