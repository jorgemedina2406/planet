...
var KTDatatableRemoteAjaxDemo = function() {
    ...
    var demo = function() {
        ...
        var route_edit = app_url + '/administracion/editar-importacion';
        var route_view = app_url + '/administracion/importacion';
        var route_delete = app_url + '/administracion/delete-import';
        var route_pdf = app_url + '/administracion/report-import-pdf';
        ...
        $('#kt_form_importer').on('change', function() {
            datatable.search($(this).val().toLowerCase(), 'importer');
        });
    ...
    var modalSubRemoteDatatable = function(id, datatable) {
        ...
        $('#changeStatus').on('click', function() {
            ...
            $.ajax({
                url: href + '?import=' + id + '&status_id=' + status + '&observation=' + observation,
                "token": $("meta[name='_token']").attr("content"),
                headers: { 'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
                type: 'post'
            }).done(function() {
