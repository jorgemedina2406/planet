...
var KTDatatableRemoteAjaxDemo = function() {
    ...
    var demo = function() {
        ...
        var route_edit = app_url + '/administracion/catalogos/editar-consignatorio';
        var route_view = app_url + '/administracion/catalogos/consignatorio';
        var route_delete = app_url + '/administracion/catalogos/delete-consignee';
        ...
        $('#consigneeSearch').keyup(function() {
            datatable.search($(this).val().toLowerCase(), 'name');
        });

        $('#postalSearch').keyup(function() {
            datatable.search($(this).val().toLowerCase(), 'postal');
        });
